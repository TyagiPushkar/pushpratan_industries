      ...
      <div className="max-w-10xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        ...
        <div className="text-center max-w-4xl mx-auto mb-16">
          ...
          <p className="text-xl text-gray-600 leading-relaxed">
            At PushpRatan, our success is a collective effort led by a dedicated and experienced management team. 
            ...
            <div className="md:col-span-3 relative">
              ...
              <div className="relative bg-white rounded-3xl p-8 shadow-xl border border-gray-100">
                ...
                <div className="space-y-4 text-gray-600 leading-relaxed">
                  ...
                  <p>
                    I am delighted to welcome you to the digital home of PushpRatan Greens Ltd., where we cultivate 
                    progress, nurture innovation, and empower a greener tomorrow. For over 12 years formerly known as 
                    'Solar Crop Science', PushpRatan has stood as a beacon of agricultural excellence. Our journey, 
                  ...
                  <p>
                    ...
                    PushpRatan is here to support you at every step.
                  </p>
                  <p>
                    Thank you for being part of the PushpRatan family. Together, let's continue to cultivate excellence 
        ...
        <div className="relative overflow-hidden rounded-3xl bg-linear-to-r from-green-600 to-emerald-600 p-12 text-white mb-16">
          ...
          <div className="relative z-10 text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-white/90 leading-relaxed">
              The leadership team at PushpRatan Greens Limited is united by a shared vision of agricultural progress 
