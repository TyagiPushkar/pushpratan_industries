...
const Footer = () => {
  ...
  const contactInfo = [
    ...
    { icon: <Mail className="w-4 h-4" />, text: 'info@pushpratan.com', href: 'mailto:info@pushpratan.com' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <p className="text-gray-400 text-sm leading-relaxed max-w-sm">
              Discover the Difference with Pushpratan Greens Limited. We're redefining agrochemical excellence 
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-500">
              © {currentYear} Pushpratan Greens Limited. All rights reserved.
            </p>
