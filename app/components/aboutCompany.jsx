          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 lg:p-16 border border-gray-100">
            ...
            <div className="mb-20">
              <div className="text-center mb-12">
                ...
                <p className="text-gray-500 max-w-2xl mx-auto text-lg">
                  The manufacturing process at PushpRatan follows a systematic four-step approach 
            ...
            <div className="mb-20">
              <div className="text-center mb-12">
                ...
                <p className="text-gray-500 max-w-2xl mx-auto text-lg">
                  Discover what makes PushpRatan the trusted choice for farmers across India
                </p>
              </div>
                ...
                <div className="group bg-white p-8 rounded-2xl border border-gray-200 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 leading-relaxed">
                        PushpRatan products are formulated with precision, utilizing advanced chemistry and technology 
