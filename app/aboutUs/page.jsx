          ...
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <div className="space-y-6 text-gray-600 text-lg leading-relaxed">
              <p className="text-xl text-gray-700">
                At PushpRatan, we're not just an agrochemical company; we're your allies in cultivating success. 
          ...
          <div className="mb-16">
            ...
            <div className="bg-linear-to-r from-amber-50 to-orange-50 rounded-3xl p-10 border border-amber-100">
              <p className="text-xl text-gray-700 leading-relaxed text-center max-w-4xl mx-auto">
                At PushpRatan, our mission is to empower farmers and growers with the tools they need to cultivate 
          ...
          <div className="relative overflow-hidden rounded-3xl bg-linear-to-r from-green-600 to-emerald-600 p-12 text-white mb-16">
            ...
            <div className="relative z-10 text-center max-w-3xl mx-auto">
              ...
              <p className="text-xl text-white/90 leading-relaxed">
                From our beginnings as Solar Crop Science to becoming PushpRatan Greens Ltd., our journey of over a decade 
